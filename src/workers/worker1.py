# WORKER1.PY - Reçoit les logs, fait la prédiction BERT et renvoie au Master
...
def process_log():
    ...
    print(f" PRÉDICTION: {predicted_category}")
...
if __name__ == "__main__":
    ...
    print("="*100)
    print(f" Serveur démarré sur: http://127.0.0.1:5001")
    print(f" Modèle BERT: {' Chargé' if MODEL_LOADED else ' Non chargé'}")
    print(f" Master URL: {MASTER_URL}")
    print(f" Utilisez ngrok pour exposer ce port: ngrok http 5001")
    print("="*100 + "\n")
